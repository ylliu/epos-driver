...
//*******************************************************************************************************************
	...
	DataRecording_DllExport int VCS_ReadChannelDataVector(void* KeyHandle, unsigned short NodeId, unsigned char ChannelNumber, unsigned char* pDataVector, unsigned int VectorSize, unsigned int* pErrorCode);
